...
import { ArrowLeft, ArrowRight, Calendar as CalendarIcon, Clock, Users, Briefcase, Loader2 } from 'lucide-react';
  ...
  return <div className="pb-6">
      <DrawerHeader>
        ...
        <DrawerDescription className="text-center">
          {step === 1 ? "Event Details" : step === 2 ? "Contact Information" : "Additional Requirements"}
        </DrawerDescription>
      </DrawerHeader>
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5 px-6">
          ...
          {step === 1 && <>
            ...
            field
                      ...
                      <PopoverTrigger asChild>
                        <FormControl>
                          <Button variant="outline" className={cn("w-full pl-3 text-left font-normal flex justify-between items-center", !field.value && "text-muted-foreground")}>
                            {field.value ? format(field.value, "PPP") : <span>Select event date</span>}
              ...
              field
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent>
                          {timeSlots.map(time => <SelectItem key={`start-${time}`} value={time}>
                              {time}
                            </SelectItem>)}
                        </SelectContent>
                      </Select>
              ...
              field
                      ...
                      <Select onValueChange={field.onChange} defaultValue={field.value}>
                        ...
                        <SelectContent>
                          {timeSlots.map(time => <SelectItem key={`end-${time}`} value={time}>
                              {time}
                            </SelectItem>)}
                        </SelectContent>
                      </Select>
            ...
            field
                    ...
                    <Select onValueChange={field.onChange} defaultValue={field.value}>
                      ...
                      <SelectContent>
                        {[5, 10, 15, 20, 25, 30, 40, 50, 60, 70, 80].map(num => <SelectItem key={num} value={num.toString()}>
                            {num} attendees
                          </SelectItem>)}
                      </SelectContent>
                    </Select>
          ...
          {step === 3 && <>
              <div className="p-4 rounded-lg mb-6 bg-zinc-950">
              ...
              <FormField control={form.control} name="requirements" render={() => <FormItem>
                    <div className="mb-4">
                    ...
                    {requirementItems.map(item => <FormField key={item.id} control={form.control} name="requirements" render={({
              field
            }) => {
            ...
            field
                    ...
                    <FormControl>
                      <Textarea placeholder="Any other requirements or information we should know?" className="min-h-[100px]" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>} />
            </>}
