...
const About: React.FC = () => {
  return (
    <div id="about" className="section-padding bg-gradient-to-b from-airbnb-cream/10 to-airbnb-cream/5 dark:from-airbnb-darkbrown/50 dark:to-airbnb-darkbrown/30">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-6 mt-8">
              <motion.div 
                className="flex items-start space-x-3 p-4 bg-white/40 dark:bg-airbnb-darkbrown/40 backdrop-blur-sm rounded-xl border border-white/30 dark:border-white/5 hover:shadow-md transition-all"
                whileHover={{ y: -5 }}
            ...
            <motion.button 
              className="mt-8 flex items-center text-airbnb-gold border border-airbnb-gold/30 px-6 py-3 rounded-full hover:bg-airbnb-gold/10 transition-colors group"
          ...
          <motion.div 
            className="h-64 md:h-auto relative rounded-xl overflow-hidden shadow-xl"
