...
const Highlights: React.FC = () => {
  return <div className="py-10 bg-zinc-900">
        ...
        <Carousel className="w-full">
          <CarouselContent className="-ml-2 md:-ml-4">
            {highlights.map(highlight => <CarouselItem key={highlight.id} className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/3">
                <Card className="border-none shadow-sm hover:shadow-md transition-shadow duration-300 overflow-hidden bg-zinc-950">
                  <CardContent className="p-6 flex flex-col items-center text-center bg-zinc-900">
