        ...
        <Carousel className="w-full">
          ...
          once: true
            ...
            <CarouselContent className="-ml-2 md:-ml-4">
              {highlights.map(highlight => <CarouselItem key={highlight.id} className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/3">
                  <motion.div variants={item} transition={{
                duration: 0.3
              }}>
                    <Card className="border-none shadow-lg hover:shadow-xl transition-shadow duration-300 overflow-hidden bg-white/80 dark:bg-airbnb-darkbrown/90 backdrop-blur-sm group">
                      <CardContent className="p-8 flex flex-col items-center text-center relative bg-stone-900">
                        ...
                        <motion.div className="w-16 h-16 rounded-full bg-gradient-to-br from-airbnb-gold/30 to-airbnb-gold/10 flex items-center justify-center mb-5 relative z-10 group-hover:scale-110 transition-transform" initial={{
                      scale: 0.8
                    }} whileInView={{
                      scale: 1
                    }} viewport={{
