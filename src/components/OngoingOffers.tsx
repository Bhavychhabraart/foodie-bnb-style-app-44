      ...
      <div className="container-padding mx-auto">
        ...
        <Carousel className="w-full">
          <CarouselContent className="-ml-2 md:-ml-4">
            {offers.map(offer => <CarouselItem key={offer.id} className="pl-2 md:pl-4 md:basis-1/2 lg:basis-1/3">
                <Card className="airbnb-card border-none">
                  <CardContent className="p-0">
                    ...
                    <div className="p-4 bg-zinc-900">
                      ...
                      <Button onClick={() => handleAvailNow(offer)} className="w-full bg-airbnb-red hover:bg-airbnb-red/90 text-white">
                        Avail Now
                      </Button>
                    </div>
                  </CardContent>
