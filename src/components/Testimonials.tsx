...
const Testimonials: React.FC = () => {
  return <div className="section-padding bg-gradient-to-b from-airbnb-cream/5 to-airbnb-cream/10 dark:from-airbnb-darkbrown/80 dark:to-airbnb-darkbrown">
                    ...
                    <Card className="border-none shadow-lg hover:shadow-xl transition-all duration-300 h-full bg-white/80 dark:bg-zinc-900/80 backdrop-blur-sm">
                      <CardContent className="p-6 relative h-full">
                        ...
                        <div className="flex mb-3">
                          {[1, 2, 3, 4, 5].map(star => <Star key={star} className={`h-4 w-4 ${star <= testimonial.rating ? 'fill-current text-airbnb-gold' : 'text-gray-300'}`} />)}
                        </div>
